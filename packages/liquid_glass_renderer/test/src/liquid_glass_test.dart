...
void main() {
  group('LiquidGlass', () {
    ...
    testWidgets(
      'allocates contributor texture only for differing appearances',
      (tester) async {
        final varied = ValueNotifier(false);
        addTearDown(varied.dispose);
        ...
        expect(renderObject().debugMaterialImage, isNotNull);
        expect(
          FlutterGpuGeometryRenderer.debugActiveMaterialTextureCount,
