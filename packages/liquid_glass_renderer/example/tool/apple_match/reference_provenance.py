...
def validate_reference(
    ...
    *,
    ...
    # manifest, but comparing them with today's capture host would invalidate
    # every old scene when an unrelated scene or background primitive is added
    # to a shared Swift file. The scene JSON and its declared API construction
    # are the current semantic contract; probe/frame hashes protect the actual
    # captured pixels. A new capture records the then-current source hashes.
    mismatches = {
