...
- `LiquidGlassSettings` exposes shared optics and lighting. Per-shape tint,
  saturation, transmission gamma, vibrancy, and materialization visibility
  live in `LiquidGlassAppearance`; `LiquidGlassVisibility` composes visibility
