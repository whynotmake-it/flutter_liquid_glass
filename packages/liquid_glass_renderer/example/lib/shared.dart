...
const _clearLoupeAppearance = LiquidGlassAppearance();
        ...
        child: Stack(
          children: [
            ...
            LiquidGlass.withOwnLayer(
              settings: settings,
              appearance: _clearLoupeAppearance,
...
class SettingsSheet extends HookWidget {
  const SettingsSheet({
    ...
    required this.appearanceNotifier,
  ...
  final ValueNotifier<LiquidGlassAppearance> appearanceNotifier;
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: CupertinoButton.tinted(
                            onPressed: () {
                              ...
                              appearanceNotifier.value = LiquidGlassAppearance(
                                saturation: 1.2,
                    ...
                    _SettingsSlider(
                      ...
                      max: 1,
                      onChanged: (value) =>
                          appearanceNotifier.value = appearance.copyWith(
                            tint: appearance.tint.withValues(
                              alpha: value,
                            ),
                          ),
                    ),
                    ...
                    _SettingsSlider(
                      ...
                      fullRendererOnly: true,
                      fullRendererInactive: fake,
                      value: appearance.transmissionGamma,
                      min: .5,
                      max: 1.5,
                      onChanged: (value) => appearanceNotifier.value =
                          appearance.copyWith(transmissionGamma: value),
                    ),
                    _SettingsSlider(
                      label: 'Vibrancy',
                      fullRendererOnly: true,
                      ...
                      max: 1,
                      onChanged: (value) => appearanceNotifier.value =
                          appearance.copyWith(vibrancy: value),
                    ),
                    ...
                    _SettingsSlider(
                      ...
                      max: 4,
                      onChanged: (value) => appearanceNotifier.value =
                          appearance.copyWith(saturation: value),
                    ),
                    _SettingsSlider(
